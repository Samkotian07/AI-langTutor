import { RoomEvent as b, ParticipantEvent as y, setLogLevel as Un, LogLevel as vt, setLogExtension as Fn, Track as M, Room as mt, TrackEvent as Ut, compareVersions as jn } from "livekit-client";
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const v = oe(i), E = oe(a) === a, P = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), L = h || (E || !p ? [Oe(a)] : Hn(a));
      !h && m !== "none" && L.push(...Yn(a, p, m, P));
      const C = [a, ...L], ie = await Bt(t, g), K = [];
      ...
      if (T = [...T, {
        ...
        if (!X)
          switch (d) {
            case "bestFit": {
              var w;
              const Z = (w = T.map((ce) => [ce.placement, ce.overflows.filter((ge) => ge > 0).reduce((ge, $n) => ge + $n, 0)]).sort((ce, ge) => ce[1] - ge[1])[0]) == null ? void 0 : w[0];
              Z && (X = Z);
              break;
            }
...
function ur(e, t) {
  ...
  for (; H(s) && !de(s); ) {
    const a = z(s), c = ot(s);
    !c && a.position === "fixed" && (i = null), (o ? !c && !i : !c && a.position === "static" && !!i && ["absolute", "fixed"].includes(i.position) || Ee(s) && !c && Kt(e, s)) ? r = r.filter((l) => l !== s) : i = a, s = ne(s);
  }
  return t.set(e, r), r;
}
function lr(e) {
...
var Pi = Object.defineProperty, Ai = Object.defineProperties, ki = Object.getOwnPropertyDescriptors, Lt = Object.getOwnPropertySymbols, Oi = Object.prototype.hasOwnProperty, Li = Object.prototype.propertyIsEnumerable, _t = (e, t, n) => t in e ? Pi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Q = (e, t) => {
  for (var n in t || (t = {}))
    Oi.call(t, n) && _t(e, n, t[n]);
  if (Lt)
    for (var n of Lt(t))
      Li.call(t, n) && _t(e, n, t[n]);
  return e;
...
function Mo(e, t = {}) {
  var n;
  _.setLevel(e), Un((n = t.liveKitClientLogLevel) != null ? n : e);
}
function Ro(e, t = {}) {
  var n;
  const r = _.methodFactory;
  _.methodFactory = (i, o, s) => {
    const a = r(i, o, s), c = vt[i], u = c >= o && c < vt.silent;
    return (l, f) => {
      f ? a(l, f) : a(l), u && e(c, l, f);
    };
  }, _.setLevel(_.getLevel()), Fn((n = t.liveKitClientLogExtension) != null ? n : e);
}
var No = [
  {
    columns: 1,
...
function Wo(e) {
  const t = [], n = [], r = [], i = [];
  e.forEach((a) => {
    a.participant.isLocal && a.source === M.Source.Camera ? t.push(a) : a.source === M.Source.ScreenShare ? n.push(a) : a.source === M.Source.Camera ? r.push(a) : i.push(a);
  });
  const o = Hi(n), s = zi(r);
  return [...t, ...o, ...s, ...i];
}
...
function zi(e) {
  ...
  }), n.sort((r, i) => r.participant.isSpeaking && i.participant.isSpeaking ? Cn(r.participant, i.participant) : r.participant.isSpeaking !== i.participant.isSpeaking ? Pn(r.participant, i.participant) : r.participant.lastSpokeAt !== i.participant.lastSpokeAt ? An(r.participant, i.participant) : F(r) !== F(i) ? Bi(r, i) : r.participant.isCameraEnabled !== i.participant.isCameraEnabled ? Vi(r, i) : Me(r.participant, i.participant)), [...t, ...n];
}
function Bo(e) {
  const t = [...e];
  t.sort((r, i) => {
...
function Ho(e) {
  const t = Mt(e), n = kn(e.participant).pipe(
    k(() => Mt(e)),
    R(t)
  );
  return { className: $(
    e.source === M.Source.Camera || e.source === M.Source.ScreenShare ? "participant-media-video" : "participant-media-audio"
  ), trackObserver: n };
}
function Mt(e) {
  if (F(e))
...
function Ko(e, t, n = !0) {
  ...
  const i = () => W(this, null, function* () {
    try {
      const a = yield mt.getLocalDevices(e, n);
      o.next(a);
    } catch (a) {
      t == null || t(a);
    }
  ...
  return De(
    mt.getLocalDevices(e, n).catch((a) => (t == null || t(a), [])),
    s
  );
}
function Zi(e) {
...
function kn(e) {
  return me(
    ...
    k((n) => {
      const { isMicrophoneEnabled: r, isCameraEnabled: i, isScreenShareEnabled: o } = n, s = n.getTrackPublication(M.Source.Microphone), a = n.getTrackPublication(M.Source.Camera);
      return {
        isCameraEnabled: i,
...
function os(e, t, n) {
  const r = new rn(void 0), i = ro(t, e), o = (a, ...c) => W(this, [a, ...c], function* (u, l = {}) {
    var f, h, d;
    if (t) {
      ...
      let p;
      e === "audioinput" ? p = (h = t.localParticipant.getTrackPublication(M.Source.Microphone)) == null ? void 0 : h.track : e === "videoinput" && (p = (d = t.localParticipant.getTrackPublication(M.Source.Camera)) == null ? void 0 : d.track);
...
function co(e) {
  return { chatObservable: eo(e), send: (i) => W(this, null, function* () {
...
function fs(e, t) {
  ...
  const i = new re(), o = () => {
    var T, x, I;
    return ((T = e.serverInfo) == null ? void 0 : T.edition) === 1 || !!((x = e.serverInfo) != null && x.version) && jn((I = e.serverInfo) == null ? void 0 : I.version, "1.17.2") > 0;
  ...
  if (d.set(l, m), Pe.set(e, d), h) {
    const { messageObservable: T } = ao(e, [l, f]);
    T.pipe(Ot(i)).subscribe(m);
  }
  const { chatObservable: p, send: g } = co(e), v = s ?? po, E = yi(
    m.pipe(
      k((T) => {
    ...
    Ot(i)
  ), P = new rn(!1), L = a ?? fo, C = (T) => W(this, null, function* () {
    P.next(!0);
    try {
...
function ds() {
  ...
  return { className: $("start-audio-button"), roomAudioPlaybackAllowedObservable: to, handleStartAudioPlayback: e };
}
function ps() {
  const e = (n) => W(this, null, function* () {
    _.info("Start Video for room: ", n), yield n.startVideo();
  });
  return { className: $("start-audio-button"), roomVideoPlaybackAllowedObservable: no, handleStartVideoPlayback: e };
}
function hs() {
...
function ws(e) {
  return On(e, Ut.TranscriptionReceived);
}
function Ss(e) {
  return On(e, Ut.TimeSyncUpdate).pipe(
    k(([t]) => t)
  );
}
function xs(e, t = 1e3) {
...
function As() {
  const [e, t] = D.useReducer(_n, En), [n, r] = D.useReducer(Ln, Tn);
  return {
...
function ks(e) {
  const [t, n] = D.useReducer(_n, En), [r, i] = D.useReducer(Ln, Tn);
  return e ?? {
...
function So() {
  return D.useContext(In);
}
const Dn = D.createContext(
  void 0
);
function Os() {
  const e = D.useContext(Dn);
  if (!e)
...
const Rn = D.createContext(void 0);
function _s() {
  const e = D.useContext(Rn);
  if (!e)
...
const Nn = D.createContext(void 0);
function Ds() {
  const e = D.useContext(Nn);
  if (!e)
...
const To = D.createContext(void 0);
function Rs(e) {
  const t = D.useContext(To);
  if (e === !0) {
    if (t)
      return t;
